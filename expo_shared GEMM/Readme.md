This code is written for VIVADO HLS. One of the two matrices is converted to the proposed storage format in [[1]](#1). The basis of the code can be found [here](https://github.com/a2824256/HLS-LeNet). 
